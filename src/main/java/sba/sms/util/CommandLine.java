...
public class CommandLine {
    ...
    public static void addData(){
        ...
        courseService.createCourse(new Course("Java", "Phillip Witkin"));
        courseService.createCourse(new Course("Frontend", "Kasper Kain"));
        courseService.createCourse(new Course("JPA", "Jafer Alhaboubi"));
        courseService.createCourse(new Course("Spring Framework", "Phillip Witkin"));
        courseService.createCourse(new Course("SQL", "Phillip Witkin"));
